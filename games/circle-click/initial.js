...
var initialState = {
    create: function(){
        var name = game.add.text(game.world.centerX, game.world.centerY - 100, 'Circle Clicker', hugeText);
        name.anchor.set(0.5);
        
        playNow = game.add.text(game.world.centerX, game.world.centerY + 30, 'Click to play!', bigText);
